...
my $resource1 = Cord::LsfParser::get_resource_from_lsf_resource($lsfresource1);
...
my $resource2 = Cord::LsfParser::get_resource_from_lsf_resource($lsfresource2);
...
my $resource3 = Cord::LsfParser::get_resource_from_lsf_resource($lsfresource3);
...
my $resource4 = Cord::LsfParser::get_resource_from_lsf_resource($lsfresource4);
...
dies_ok { Cord::LsfParser::get_resource_from_lsf_resource($lsfresource5) } 'fails on bad rusage predicate';

my $lsfresource6 = "rusage[mem=8000, tmp=2000] select[badpredr>=142 && type==LINUX64 && mem > 8000 && tmp > 2000] span[hosts=1] -M 8000000";
dies_ok { Cord::LsfParser::get_resource_from_lsf_resource($lsfresource6) } 'fails on bad rusage predicate';

my $lsfresource7 = "rusage[mem=8000, tmp=2000] select[ncpus >= 4 && type==LINUX64 && mem > 8000 && tmp > 2000] span[hosts=1] -M 80000 -n 2";
dies_ok { Cord::LsfParser::get_resource_from_lsf_resource($lsfresource7) } 'fails on -n # and select[ncpus >= #] mismatch';

my $lsfresource8 = "rusage[mem=8000, tmp=2000] select[ncpus >= 4] span[hosts=1]";
my $resource8 = Cord::LsfParser::get_resource_from_lsf_resource($lsfresource8);
ok($resource8->min_proc == 4, 'ncpus parsed properly');

my $resource9 = Cord::LsfParser->get_resource_from_lsf_resource($lsfresource8);
