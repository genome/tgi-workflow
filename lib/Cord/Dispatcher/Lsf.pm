package Cord::Dispatcher::Lsf;

use strict;
use warnings;

class Cord::Dispatcher::Lsf {
    is => 'Cord::Dispatcher',
};
...
sub execute {
    ...
    warn("Cord LSF Dispatcher issuing command: $cmd");
...
sub get_command {
    ...
    # Cord exclusive execution mode to run only one job per blade -- for use when benchmarking
